...
def test_save_catalog_and_margin(local_data_dir, storage_options, tmp_cloud_path):
    ...
    catalog.to_hipscat(base_catalog_path, file_system=file_system, storage_options=storage_options)
    expected_catalog = lsdb.read_hipscat(
        base_catalog_path, file_system=file_system, storage_options=storage_options
    )
    ...
    catalog.margin.to_hipscat(base_catalog_path, file_system=file_system, storage_options=storage_options)
    expected_catalog = lsdb.read_hipscat(
        base_catalog_path, file_system=file_system, storage_options=storage_options
    )
