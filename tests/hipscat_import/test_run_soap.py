...
def test_object_to_self_write_to_cloud(
    ...
    """
    with TempCloudDirectory(tmp_dir_cloud, "run_soap", example_cloud_storage_options) as temp_path:
        ...
        catalog = AssociationCatalog.read_from_hipscat(
            small_sky_soap_args.catalog_path, storage_options=example_cloud_storage_options
        )
        ...
        parquet_file_name = os.path.join(
            small_sky_soap_args.catalog_path, "Norder=0", "Dir=0", "Npix=11.parquet"
        )
...
def test_object_to_self_read_from_cloud(
    dask_client, tmp_path, small_sky_dir_cloud, small_sky_order1_dir_cloud, example_cloud_storage_options
):
    """Test creating association between object catalogs.
    ...
    small_sky_soap_args = SoapArguments(
        ...
        object_id_column="id",
        object_storage_options=example_cloud_storage_options,
        source_catalog_dir=small_sky_order1_dir_cloud,
        source_object_id_column="id",
        source_id_column="id",
        source_storage_options=example_cloud_storage_options,
        write_leaf_files=True,
        output_artifact_name="small_sky_to_order1",
